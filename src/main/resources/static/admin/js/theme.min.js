...
$.extend({
    ...
    t.HSCore.components.HSDatatables = {
        defaults: {
            ...
            paginationPrevLinkMarkup: '<span aria-hidden="true"><i class="fas fa-arrow-left"></i></span>',
            paginationNextClasses: "page-item",
            paginationNextLinkClasses: "page-link",
            paginationNextLinkMarkup: '<span aria-hidden="true"><i class="fas fa-arrow-right"></i></span>',
            detailsInvoker: null,
            select: null
        }, init: function (e, a) {
            if (e.length) {
